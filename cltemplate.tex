...
\setmainfont{Helvetica}[ SizeFeatures={Size=8} ]
\setromanfont{Helvetica}[ SizeFeatures={Size=8} ]
...
\newcommand{\header}[9]{
    ...
    \parbox[b][0.625in][t]{6.5in}{
        ...
        \parbox[b][0.625in][t]{3.74in}
            {\href{http://www.think3dots.com}
            {\includegraphics[height=1in]{./t3d-logo-V2.pdf}}}\hfill
...
\header{$head.address$}{$head.city$}{$head.state$}{$head.zip$}{$head.phone$}{$head.fax$}{$head.email$}{$sig.name-short$}{$head.dept$}
